...
class Vector:
    ...
    def get_polar_from_reference(self, reference_point):
        #This will return this vector expressed as a distance and angle from reference_point (also a vector vector).
    ...
    def point_at_polar_from_reference(polar, reference_point):
        #This will return a vector created from a polar which is relative to reference_point (also a vector).
